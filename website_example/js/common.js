...
function formatLuck(difficulty, shares) {
    ...
    if(!percent){
        ...
        return '<span class="luckGood">' + percent.toLocaleString('en-US') + '%</span>';
    }
    else if(percent >= 101 && percent <= 150){
        return '<span class="luckMid">' + percent.toLocaleString('en-US') + '%</span>';
    }
    else{
        return '<span class="luckBad">' + percent.toLocaleString('en-US') + '%</span>';
    }    
}
